...
from audio2map.pattern_analyser.osu_parser import parse_osu_mania
from audio2map.pattern_analyser.patterns_def import CorePattern
from audio2map.pattern_analyser.summary import from_chart
