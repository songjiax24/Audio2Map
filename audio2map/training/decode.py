"""Constrained decoding state machine for v2 ROW tokens."""
...
class ChartDecodeState:
    ...
    def __post_init__(self) -> None:
        ...
        self._pos_ids = [self.vocab[pos_token(p)] for p in range(TICKS_PER_BAR)]
    ...
    def from_initial_row(
        ...
        *,
        ...
        from audio2map.osu.row_tokens import active_hold_from_initial_row
